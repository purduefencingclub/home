  ...
  <>
    ...
    <Container className="fencing-body">
      ...
      <Eventcard cardTitle="Beginner's Class"
       ...
       cardFooterText="Next Class: September 4th, 9:00pm | Location: Corec MP5"
       cardImage={beginner}
       />
      <Eventcard cardTitle="Practice / Open Fencing"
       cardBody="Standard practices with open fencing from 9:00pm to 11:45pm on Tuesday and Thursday, and 10:00am-12:00pm on Sundays. Fencers who have not yet signed their safety waivers can click the button below."
